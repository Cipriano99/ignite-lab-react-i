    ...
    <div className="p-8 max-w-[1100px] mx-auto">
      <div className="flex items-start gap-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a href="" className="p-4 text-smal border border-blue-500 text-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-500 hover:text-gray-900 transition-colors">
            <Lightning size={24} />
            Acesse o desafio
          </a>
        </div>
      ...
      <div className="gap-8 mt-20 grid grid-cols-2">
        <a href="#" className="bg-gray-700 rounded overflow-hidden flex items-start gap-6">
          ...
          <div className="h-full p-6 flex items-center hover:bg-gray-600 transition-colors">
            <CaretRight size={24} />
          </div>
        </a>
